...
uint256 hashGenesisBlock("0x0de95dd283469ff9fa5a05372a47ca21c0bda32ab939f18d18e88d28d464e825");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x13341787ca900fb1c2818082306188514acf0043570e83c1ddb8cf8011fd0c93");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1500126443; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 765230;

        if (fTestNet)
        {
            block.nTime    = 1500024328;
            block.nNonce   = 693635;
        }
